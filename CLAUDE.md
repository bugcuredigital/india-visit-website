...
`/` · `/destinations/` (index) · `/destinations/{slug}/` · `/journeys/` · `/journeys/{slug}/` · `/luxury-trains/` (landing) · `/corporate/` · `/about/` · `/reviews/` · `/travel-guide/` · `/travel-guide/{slug}/` · `/plan-my-trip/` · `/privacy/` `/terms/` `/cancellation/` `/booking-terms/`
...
- Lighthouse (mobile, throttled): Performance ≥ 90, Accessibility ≥ 95, SEO ≥ 95; LCP ≤ 2.0s on the changed pages (2.5s hard ceiling)
