...
const PHOTOS = [
  ...
  /* ---- M5 journey heroes (design-review stand-ins, replaced by the client's
     archive). Every id was checked against the Unsplash page for licence:
     four candidates (Jaisalmer x2, a Mysore interior, a Thiksey alternate and
     a Udaipur Lake Palace) turned out to be Unsplash+ and were dropped. ---- */
  {
    name: 'journey-gt-amritsar',
    id: 'photo-1761924422461-2aad2800020b',
    width: 2400,
    hero: true,
    credit: 'helen chevrier',
    subject: 'The Golden Temple at Amritsar reflected in the Amrit Sarovar',
    usedFor: 'journey hero — Golden Triangle from Amritsar 11N/12D',
  },
  {
    name: 'journey-gt-varanasi',
    id: 'photo-1762513839526-c596f5e99a9a',
    width: 2400,
    hero: true,
    credit: 'Vizag Explore',
    subject: 'Boats on the Ganges below the Varanasi ghats',
    usedFor: 'journey hero — Golden Triangle with Varanasi 9N/10D',
  },
  {
    name: 'journey-gt-jhalana',
    id: 'photo-1659531166056-2b96f0c6259d',
    width: 2400,
    hero: true,
    credit: 'Gurth Bramall',
    subject: 'A leopard standing on a rock',
    usedFor: 'journey hero — Golden Triangle with Jhalana Leopard Reserve 6N/7D',
  },
  {
    name: 'journey-rajasthan-tour',
    id: 'photo-1655106606416-f65f790cff66',
    width: 2400,
    hero: true,
    credit: 'Vikram Chouhan',
    subject: 'A chhatri at the Jagmandir island palace on Lake Pichola, Udaipur',
    usedFor: 'journey hero — Rajasthan Tour 12N/13D',
  },
  {
    name: 'journey-kerala-week',
    id: 'photo-1610817201767-793a9130ce07',
    width: 2400,
    hero: true,
    credit: 'Anand S',
    subject: 'The Varkala cliff and beach at daybreak',
    usedFor: 'journey hero — Kerala in a Week 7N/8D',
  },
  {
    name: 'journey-kerala-trivandrum',
    id: 'photo-1701793035486-c6b4368aa842',
    width: 2400,
    hero: true,
    credit: 'Ananya Anand',
    subject: 'Kovalam beach with the lighthouse in the distance',
    usedFor: 'journey hero — Kerala & the Southern Coast 12N/13D',
  },
  {
    name: 'journey-leh-ladakh',
    id: 'photo-1760835251791-1fda687de791',
    width: 2400,
    hero: true,
    credit: 'Ben Gillam',
    subject: 'Thiksey monastery rising above the Indus valley, Ladakh',
    usedFor: 'journey hero — Leh, Ladakh & Kashmir 10N/11D',
  },
  {
    name: 'journey-north-east-roots',
    id: 'photo-1742494340594-f745a81e2136',
    width: 2400,
    hero: true,
    credit: 'Abhishek Tirkey',
    subject: 'The double-decker living root bridge at Nongriat, Meghalaya',
    usedFor: 'journey hero — North East India: Root Bridges & Majuli 6N/7D',
  },
  {
    name: 'journey-vietnam',
    id: 'photo-1741274236412-b6760ff6c01b',
    width: 2400,
    hero: true,
    credit: 'Daniele Franchi',
    subject: 'A lantern-lit bridge in Hoi An at night',
    usedFor: 'journey hero — Vietnam 7N/8D',
  },
  {
    name: 'journey-bhutan',
    id: 'photo-1608236475016-1dcc7a260326',
    width: 2400,
    hero: true,
    credit: 'Raimond Klavins',
    subject: 'Punakha Dzong in the Bhutan Himalaya',
    usedFor: 'journey hero — Bhutan 7N/8D',
  },
  {
    name: 'journey-golden-chariot',
    id: 'photo-1659126574791-13313aa424bd',
    width: 2400,
    hero: true,
    credit: 'Mahendra Maddirala',
    subject: 'Mysore Palace seen through its arched gateway',
    usedFor: 'journey hero — Golden Chariot: Jewels of the South 5N/6D',
  },
  {
    name: 'dest-rajasthan',
